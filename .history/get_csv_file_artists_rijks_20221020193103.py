# This is a long process takes around 10 hours to run.
...
for index, objNumber in (enumerate(tqdm(df['objectInventoryNumber']))):
...
expoort_data_frame.to_csv(
    './Collections/Rijks_Collection/Final_Artist_Data_Rijks.csv', index=False)
